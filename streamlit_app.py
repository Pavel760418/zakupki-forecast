...
- **Перемещение со склада** (режим «по магазинам»): до заказа поставщику остаток «Склад основной1» распределяется в точки с дефицитом (сначала Флагман, затем по продажам). Заказ поставщику уменьшается на перемещённое количество.
